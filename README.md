...
# Process
- Cleaned and filtered raw dataset.
- Engineered an artist frequency feature
- Ran correlation analysis across all numeric attributes
- Visualized relationships using heatmaps, scatter plots, regression plots, and bar charts
